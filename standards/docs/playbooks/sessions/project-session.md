...
## Curriculum Role
- `docs/curriculum.md` is the living learning roadmap.
...
## Standards Proposals Workflow (Project Sessions)
Use this when project/teaching sessions cannot directly modify shared standards.

- Log proposed standards changes in `docs/standards-proposals.md` (or `docs/standards-proposals/YYYY-MM-DD-<slug>.md`).
- Use `shared/sheffler_standards/docs/templates/standards-proposal-template.md` for consistent fields.
- Include a link to the session log and a concise rationale.
